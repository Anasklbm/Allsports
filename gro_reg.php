...
if(isset($_POST['b12']))
{
  ...
  $t5=$_POST['t5'];
    ...
    {   
    $ins=mysqli_query($dbcon,"insert into gro_data values('','$t1','$t2','$t3','$t4','$t5','$t7','$t8','$t9','$nfn','0')");
    if($ins>0)
    {
        $ins1=mysqli_query($dbcon,"insert into user_login values('','$t8','$t9','gro','0')");
        if($ins1>0)
        {
                header("location:gro_reg.php");
            }
    }
}  
}
...
<div class="wrap push">
	...
	<div class="page-heading-breadcrumbs">
		<div class="container">
			<h2>Turf/Ground Registration</h2>
		...
		<div class="error-holder theme-padding">
            ...
            <div class="form-group"> 	 
                ...
                <select class="form-control"name="t2">
                    <option>--Select Ground Type--</option>
...
<div class="form-group"> 	 
                ...
                <textarea cols="4"rows="4" class="form-control"required=""name="t3"></textarea>
                        <div id="errFirst"></div>    
            </div>
            <div class="form-group"> 	 
    ...
    <script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyDge58kDZRSDquz16IhEFQZMzHjMpFWwlw&libraries=places&callback=initAutocomplete"
         async defer></script>
                ...
                <input type="text"class="form-control" name="t4"id="lat"placeholder="Double Click on the map" value="">
                                
                        <div id="errFirst"></div>    
            </div>
                <div class="form-group"> 	 
                <label for="firstname"><span class="req">* </span> longitude: </label>
                    <input type="text" class="form-control"name="t5"placeholder="Double Click on the map" id="lng" value="">
...
<div class="form-group">
            <label for="phonenumber"><span class="req">* </span> Phone Number: </label>
                    <input required type="text" name="t7" id="phone" class="form-control phone"  onblur="chkc(this.value)" /><span id="o3"></span> 
            </div>
            <div class="form-group">
                <label for="email"><span class="req">* </span> Email Address: </label> 
                    <input class="form-control" required type="text" name="t8" id = "email"  onchange="email_validate(this.value);" />   
            ...
            <div class="form-group">
                <label for="password"><span class="req">* </span> Password: </label>
                    <input required name="t9" type="password" class="form-control inputpass"   id="pass1" /> </p>
