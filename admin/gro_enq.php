...
if(isset($_GET['upd']))
{
    ...
    $upd=$_GET['upd'];
    $upd1=mysqli_query($dbcon,"update gro_data set st='1'where em='$upd'");
                            ...
                            if(isset($_GET['del']))
{
    ...
    $upd=$_GET['del'];
    $upd1=mysqli_query($dbcon,"update gro_data set st='2'where em='$upd'");
      ...
      *********************************************************************************************************************************************************** -->
      ...
      <section id="main-content">
          <section class="wrapper">
          	<h3><i class="fa fa-angle-right"></i> Turf/Ground Enquiry</h3>
		  		<div class="row mt">
			  		<div class="col-lg-12">
                      <div class="content-panel">
                          ...
                          <section id="unseen">
                                ...
                                <?php
                                                        ...
                                                        $sel_gal=mysqli_query($dbcon,"select * from gro_data where st='0' order by id desc");
                            ...
                            <table class="table table-bordered table-striped table-condensed">
                              ...
                              <tr>
                                  ...
                                  <td ><img style="width: 105px;height: 80px" src="../img2/<?php echo $r_gal[9] ?>"></td>
                                  <td class="numeric"><?php echo $r_gal[2] ?></td>
                                  <td class="numeric"><?php echo $r_gal[3] ?></td>
                                  <td class="numeric"><?php echo $r_gal[6] ?></td>
                                   <td class="numeric"><?php echo $r_gal[7] ?></td>
                                  <td class="numeric"><a style="color: green" href="gro_enq.php?upd=<?php echo $r_gal[7] ?>" class="fa fa-check"></a>&nbsp;&nbsp;<a style="color: red" href="gro_enq.php?del=<?php echo $r_gal[7] ?>" class="fa fa-close"></a></td>
