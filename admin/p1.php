      ...
      *********************************************************************************************************************************************************** -->
      ...
      <section id="main-content">
          <section class="wrapper">
          	<h3><i class="fa fa-angle-right"></i> Forward Ranking</h3>
                        ...
                        <section id="unseen">
                            <table class="table table-bordered table-striped table-condensed">
                              ...
                              <tr>
                                  ...
                                  <th class="numeric"><b>Goals</b></th>
                                  <th class="numeric">Assist</th>
                              ...
                              <tbody>
                                  <?php
                                                        ...
                                                        $sel_gal=mysqli_query($dbcon,"select * from fb_squad where pos='Forward' order by goal desc");
                              ...
                              <tr>
                                  ...
                                  <td class="numeric"><b><?php echo $r_gal[11] ?></b></td>
                                  <td class="numeric"><?php echo $r_gal[12] ?></td>
                                  <td class="numeric"><?php echo $r_gal[13] ?></td>
