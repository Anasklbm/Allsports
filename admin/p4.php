      ...
      *********************************************************************************************************************************************************** -->
      ...
      <section id="main-content">
          <section class="wrapper">
          	<h3><i class="fa fa-angle-right"></i> GoalKeeper Ranking</h3>
                            ...
                            <table class="table table-bordered table-striped table-condensed">
                              ...
                              <tbody>
                                  <?php
                                                        ...
                                                        $sel_gal=mysqli_query($dbcon,"select * from fb_squad where pos='Goalkeeper' order by sav desc");
                              ...
                              <tr>
                                  ...
                                  <td class="numeric"><b><?php echo $r_gal[14] ?></b></td>
                              </tr>
                              <?php
                                                            }
                                                        }
