...
$msg2=  nl2br($msg1);
    ...
    $a=mysqli_query($dbcon,"select max(id) from tor");
$id=mysql_result($a,0);
$id++;
$f=$_FILES['f1']['name'];
$ext=strchr($f,'.');
...
{   
    $ins=mysqli_query($dbcon,"insert into tor values('','$t1','$msg2','$t3','$t4','$t5','$t6','$fname','0')");
    if($ins>0)
    {
        
                header("location:add_trp.php?suss=1");
            }
    }
          ...
          <section class="wrapper">
          	...
          	<div class="row mt">
                  ...
                  <div class="form-panel">
                  	  <h4 class="mb"><i class="fa fa-angle-right"></i>Add Tournament</h4>
                      <form class="form-horizontal style-form" method="post"enctype="multipart/form-data">
                          ...
                          <div class="form-group">
                           ...
                           <div class="form-group">
                              <label class="col-sm-2 col-sm-2 control-label">Venu</label>
                              <div class="col-sm-10">
                                  <input name="t4" type="text" class="form-control">
                          ...
                          <div class="form-group">
                              ...
                              <div class="col-sm-10">
                                  <input name="t5" type="date" class="form-control">
                                 
                              </div>
                          </div>
                          <div class="form-group">
                              <label class="col-sm-2 col-sm-2 control-label">Last Date</label>
                              <div class="col-sm-10">
                                  <input name="t6" type="date" class="form-control">
                    ...
                    <div class="col-lg-6">
                        <div class="form-panel">
                            <img style="width: 100%;height: 660px" src="img1/e3154fbd6079033a33fe5ae25bc5ef89--cr-ronaldo-cristiano-ronaldo.jpg">
                        </div>
                    </div><!-- col-lg-12-->      	
          	</div><!-- /row -->
