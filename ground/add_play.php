  ...
  document.getElementById("field_terms").setCustomValidity("Please indicate that you accept the Terms and Conditions");
                        ...
                        <div class="col-md-6">
                            ...
                            <?php
                                                        ...
                                                        $sel_gal=mysqli_query($dbcon,"select * from g_typ where gid='$usr' ");
                            ...
                            <table class="table table-bordered table-striped table-condensed">
                              ...
                              <tr>
                                  ...
                                  <td class="numeric"><a style="color: green" href="add_tim.php?mid=<?php echo $r_gal[0] ?>" class="fa fa-plus"></a>&nbsp;&nbsp;<a style="color: red" href="add_play.php?del=<?php echo $r_gal[0] ?>" class="fa fa-trash"></a></td>
