	...
	<main class="main-content">
		...
		<div class="error-holder theme-padding">
           ...
           <div class="form-group"> 	 
                <label for="firstname"><span class="req">* </span> Court: </label>
                <select class="form-control"required="" name="t1">
            ...
            <div class="form-group"> 	 
                <label for="firstname"><span class="req">* </span>  From: </label>
                    <input class="form-control" type="time" name="t2"  required /> 
                        <div id="errFirst"></div>    
            </div>
                
<div class="form-group"> 	 
                <label for="firstname"><span class="req">* </span>  To: </label>
                    <input class="form-control" type="time" name="t3"  required /> 
                        <div id="errFirst"></div>    
            </div>
                <div class="form-group"> 	 
                <label for="firstname"><span class="req">* </span>  Rate: </label>
                    <input class="form-control" type="number" name="t4"  required /> 
                        <div id="errFirst"></div>    
            </div>
                <center>
  ...
  document.getElementById("field_terms").setCustomValidity("Please indicate that you accept the Terms and Conditions");
                        ...
                        <div class="col-md-6">
                            ...
                            <?php
                                                        ...
                                                        $sel_gal=mysqli_query($dbcon,"select * from tim where sid='$mid' ");
                            ...
                            <table class="table table-bordered table-striped table-condensed">
                              ...
                              <tr>
                                  <td><?php echo $i ?></td>
                                  <td><?php echo substr($r_gal[2],0,5)?> - <?php echo substr($r_gal[3],0,5)?></td>
                                  <td><?php echo $r_gal[1] ?></td>
                                 <td><?php echo $r_gal[4] ?> Rs/-</td>
                                  <td class="numeric"><a style="color: red" href="add_tim.php?del=<?php echo $r_gal[0] ?>&mid=<?php echo $mid ?>" class="fa fa-trash"></a></td>
