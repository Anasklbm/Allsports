<?php
 ...
 $sel12=mysqli_query($dbcon,"select * from add_club where uid='".$_SESSION['uid']."'");
				...
				<div class="maga-drop-wrap">
					...
					<ul class="nav-list pull-right">
						<li>
                                                ...
                                                <li><a href="reg.php">Add Players</a></li>
						...
						<li>
					    	...
					    	<ul>
                                                    ...
                                                    <li><a href="match1.php">Upcoming Matches</a></li>
                                                    <li><a href="match_result1.php">Match Results</a></li>
