							...
							<div class="matches-dates-shedule">
								<ul>
									<?php
                                                        ...
                                                        $sel_gal=mysqli_query($dbcon,"select * from fb_match  where st='0' and c1_id='$usr' order by date");
									...
									<?php
                                                        ...
                                                        $sel_gal=mysqli_query($dbcon,"select * from fb_match  where st='0' and c2_id='$usr' order by date");
                                                        if(mysqli_num_rows($sel_gal)>0)
