...
?>
<?php
$sel=mysqli_query($dbcon,"select * from add_club where uid='".$_SESSION['uid']."'");
...
<div class="wrap push">
	...
	<main class="main-content">	
		...
		<!-- Team Width Sidebar -->
                <div class="team-grid theme-padding white-bg"style="background-size: cover;background-repeat: no-repeat;background-attachment: fixed;background-image: url(../state/img1/<?php echo $r[7] ?>)">
			<div class="container">
				...
				<div class="row">
					...
					<!-- Team Column -->
                                        ...
                                        <?php
                                                        $sel_gal=mysqli_query($dbcon,"select * from fb_squad where  cid='$usr'");
					...
					<div class="col-lg-3 col-sm-4 col-xs-6 r-full-width">
						<div class="team-column">
                                                    <img src="img1/<?php echo $r_gal[8] ?>" alt="">
