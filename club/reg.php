...
if(isset($_POST['b1']))
 {
   ...
   $a=mysqli_query($dbcon,"select max(id) from fb_squad");
$id=mysql_result($a,0);
$id++;
$f=$_FILES['f1']['name'];
$ext=strchr($f,'.');
...
{ 
    $ins=mysqli_query($dbcon,"insert into fb_squad values('','$t1','$t2','$t3','$t4','$t5','$t7','$t8','$fname','$r[1]','$r[5]','0','0','0','0','0')");
    if($ins>0)
    {
	...
	<main class="main-content">
		...
		<div class="error-holder theme-padding">
            ...
            <div class="form-group"> 	 
                ...
                <div class="form-group"> 	 
                <label for="firstname"><span class="req">* </span>  Age: </label>
                    <input class="form-control" type="text" name="t2"  required /> 
                        <div id="errFirst"></div>    
            </div>
                <div class="form-group"> 	 
                <label for="firstname"><span class="req">* </span>  Date of Birth: </label>
                    <input class="form-control" type="date" name="t3"  required /> 
                        <div id="errFirst"></div>    
            </div>
<div class="form-group">
            <label for="phonenumber"><span class="req">* </span> Phone Number: </label>
                    <input required type="text" name="t4" id="phone" class="form-control phone" onblur="chkc(this.value)" /><span id="o3"></span> placeholder="not used for marketing"/> 
            </div>
            <div class="form-group">
                <label for="email"><span class="req">* </span> Email Address: </label> 
                    <input class="form-control" required type="text" name="t5" id = "email"  onchange="email_validate(this.value);" />   
                        <div class="status" id="status"></div>
            </div>
                
                <div class="form-group"> 	 
                <label for="firstname"><span class="req">* </span>  Squad No: </label>
                    <input class="form-control" type="text" name="t7"  required /> 
                        <div id="errFirst"></div>    
            </div>
            <div class="form-group">
                <label for="lastname"><span class="req">* </span> Position: </label> 
                 <input class="form-control" type="text" name="t8"  required /> 
                        <div id="errLast"></div>
            </div>
