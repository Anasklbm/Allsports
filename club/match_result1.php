					...
					<div class="col-lg-9 col-sm-8">
						...
						<div class="matches-dates-shedule style-2">
							...
							<ul>
                                                        ...
                                                        $sel_gal=mysqli_query($dbcon,"select * from fb_final where c1_id='$usr' order by date");
								...
								<?php
                                                       ...
                                                       ?>
                                                        ...
                                                        $sel_gal=mysqli_query($dbcon,"select * from fb_final where c2_id='$usr' order by date");
                                                        if(mysqli_num_rows($sel_gal)>0)
