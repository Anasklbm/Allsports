					...
					<ul class="nav-list pull-right">
						<li>
					    	...
					    	<ul>
							    ...
							    <li><a href="../temp/home-2.html">Home 2</a></li>
						  	</ul>
						</li>
						<li><a href="../temp/about.html">about</a></li>
						<li>
					    	<a href="../temp/team.html">team</a>
					    	<ul>
							    <li><a href="../temp/team.html">team</a></li>
							    <li><a href="../temp/team-detail.html">Team detail</a></li>
							    <li><a href="../temp/team-width-sidebar.html">team-widthsidebar</a></li>
						  	</ul>
						</li>
							    		...
							    		<div id="mega-blog-slider" class="mega-blog-slider">
											...
											<div class="item">
												...
												<div class="large-post-img">
													<img src="../temp/images/blog-grid-view/img-2-1.jpg" alt="">
												</div>
												<!-- Post Img -->
											...
											<div class="item">
												...
												<!-- Post Img -->
												<div class="large-post-img">
													<img src="../temp/images/blog-grid-view/img-2-2.jpg" alt="">
												</div>
												<!-- Post Img -->
											...
											<div class="item">
												...
												<!-- Post Img -->
												<div class="large-post-img">
													<img src="../temp/images/blog-grid-view/img-2-3.jpg" alt="">
												</div>
												<!-- Post Img -->
											...
											<div class="item">
												...
												<!-- Post Img -->
												<div class="large-post-img">
													<img src="../temp/images/blog-grid-view/img-2-4.jpg" alt="">
												</div>
												<!-- Post Img -->
						...
						<li>
					    	<a href="#">pages</a>
					    	<ul>
					    		<li><a href="../temp/gallery.html">gallery</a></li>
					    		<li><a href="../temp/blog.html">blog</a></li>
					    		<li><a href="../temp/blog-detail.html">blog detail</a></li>
					    		<li><a href="../temp/blog-grid-view.html">blog grid view</a></li>
					    		<li><a href="../temp/blog-grid-view-2.html">blog grid view-2</a></li>
					    		<li><a href="../temp/blog-larg-view.html">blog larg view</a></li>
					    		<li><a href="../temp/blog-list-view.html">blog list view</a></li>
					    		<li><a href="../temp/point-table.html">point table</a></li>
	...
	<div class="inner-banner style-2 overlay-dark theme-padding parallax-window" data-appear-top-offset="600" data-parallax="scroll" data-image-src="../temp/images/inner-banner/img-04.jpg">
		<div class="container">
			<div class="pager-heading match-detail white-heading">
				<span class="pull-left"><img src="../temp/images/match-detail/team-logo-03.png" alt=""></span>
				...
				<span class="pull-right"><img src="../temp/images/match-detail/team-logo-04.png" alt=""></span>
			</div>
		</div>
	</div>
	<!-- Page Heading banner -->
					...
					<div class="matches-shedule-holder">
						<div class="col-lg-9 col-sm-8">
							...
							<div class="matches-dates-shedule">
								<ul>
									<li>
										<span class="pull-left"><img src="../temp/images/matches-logo/img-01.png" alt=""></span>
										<span class="pull-right"><img src="../temp/images/matches-logo/img-02.png" alt=""></span>
										<div class="detail">
									...
									<li>
										<span class="pull-left"><img src="../temp/images/matches-logo/img-03.png" alt=""></span>
										<span class="pull-right"><img src="../temp/images/matches-logo/img-04.png" alt=""></span>
										<div class="detail">
											<a href="#">Match Detail<i class="fa fa-angle-double-right"></i></a>
											<strong>southampton<i class="red-color"> 6 Feb 2016 15:00</i> liverpool</strong>
											<span class="location-marker"><i class="fa fa-map-marker"></i>3358 Evergreen Lane England</span>
									...
									<li>
										<span class="pull-left"><img src="../temp/images/matches-logo/img-05.png" alt=""></span>
										<span class="pull-right"><img src="../temp/images/matches-logo/img-06.png" alt=""></span>
										<div class="detail">
											<a href="#">Match Detail<i class="fa fa-angle-double-right"></i></a>
											<strong>southampton<i class="red-color"> 6 Feb 2016 15:00</i> liverpool</strong>
											<span class="location-marker"><i class="fa fa-map-marker"></i>3358 Evergreen Lane England</span>
					...
					<div class="col-lg-3 col-sm-4">
						...
						<div class="aside-widget">
							...
							<div class="Popular-news">
								<ul>
									<li>
										<img src="../temp/images/popular-news/img-01.jpg" alt="">
										<h5><a href="#">Two touch penalties, imaginary cards</a></h5>
										<span class="red-color"><i class="fa fa-clock-o"></i>22 Feb, 2016</span>
									</li>
									<li>
										<img src="../temp/images/popular-news/img-02.jpg" alt="">
										<h5><a href="#">Two touch penalties, imaginary cards</a></h5>
										<span class="red-color"><i class="fa fa-clock-o"></i>22 Feb, 2016</span>
									</li>
									<li>
										<img src="../temp/images/popular-news/img-03.jpg" alt="">
										<h5><a href="#">Two touch penalties, imaginary cards</a></h5>
										<span class="red-color"><i class="fa fa-clock-o"></i>22 Feb, 2016</span>
									</li>
									<li>
										<img src="../temp/images/popular-news/img-04.jpg" alt="">
										<h5><a href="#">Two touch penalties, imaginary cards</a></h5>
										<span class="red-color"><i class="fa fa-clock-o"></i>22 Feb, 2016</span>
									</li>
								</ul>
...
<nav id="menu" class="responive-nav">
	<a class="r-nav-logo" href="#"><img src="../temp/images/logo-1.png" alt=""></a>
