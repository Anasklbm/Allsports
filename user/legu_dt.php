				...
				<div class="row">
					...
					<div class="col-lg-12 col-md-12 col-sm-10 col-xs-12">
						...
						<div class="blog-detail-holder">
							...
							<article>
                                                            <p>Match details will be announced shortly the last date for registration is <b style="color: red"><?php echo $b1[5] ?></b>. After Registration please check our website for match details </p>
							</article>
