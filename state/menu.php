<?php
 ...
 $sel12=mysqli_query($dbcon,"select * from ad_st where uid='".$_SESSION['uid']."'");
			...
			<div class="container">
				...
				<ul class="user-login-option pull-right">
					...
					<li class="login-modal">
						<a href="#" class="login" data-toggle="" data-target=""><i class="fa fa-user"></i><?php echo $r12[2] ?></a>
				...
				<div class="maga-drop-wrap">
					...
					<ul class="nav-list pull-right">
						<li>
                                                ...
                                                <li><a href="reg.php">Add Club</a></li>
                                                <li><a href="st_team.php">My Clubs</a></li>
                                                <li><a href="st_team1.php">Clubs Request</a></li>
						<li>
