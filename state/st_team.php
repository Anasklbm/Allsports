...
if(isset($_GET['w']))
{
    ...
    $upd1=mysqli_query($dbcon,"update add_club set fb_won=fb_won+1 where id='$w'");
...
if(isset($_GET['l']))
{
    ...
    $upd1=mysqli_query($dbcon,"update add_club set fb_loss=fb_loss+1 where id='$l'");
...
<?php
                            if(isset($_GET['del']))
{
    $del1=mysqli_query($dbcon,"delete from add_club where id='".$_GET['del']."'");
    //echo mysql_error();
    if($del1>0)
    {
       header("location:st_team.php");
								...
								<div class="table-responsive">
									<table class="table table-bordered table-hover">
									    ...
									    <tbody>
                                                                                    ...
                                                                                    <?php
                                                        $sel_gal=mysqli_query($dbcon,"select * from add_club where sid='$usr'");
                                                        if(mysqli_num_rows($sel_gal)>0)
                                                        {$i=0;
                                                            while($r_gal=mysqli_fetch_row($sel_gal))
                                                            {
										        ...
										        <td><?php echo $r_gal[11] ?><br/>
                                                                                            <a href="st_team.php?w=<?php echo $r_gal[0] ?>"><span style="color: green" class="fa fa-plus"></span></a></td>
										        <td><?php echo $r_gal[12] ?><br/>
                                                                                            <a href="st_team.php?l=<?php echo $r_gal[0] ?>"><span style="color: green"  class="fa fa-plus"></span></a></td>
										        <td><?php echo $r_gal[13] ?><br/>
                                                                                            <a href="st_team.php?d=<?php echo $r_gal[0] ?>"><span style="color: green"  class="fa fa-plus"></span></a></td>
                                                                                        <td><a href="team.php?mid=<?php echo $r_gal[5] ?>"><span style="color: blue" class="fa fa-users"></span></a></td>
                                                                                        <td><a href="st_team.php?del=<?php echo $r_gal[0] ?>"><span style="color: red" class="fa fa-trash"></span></a></td>
                                                                                            <?php
                                                            }
                                                        }
                                                            ?>
